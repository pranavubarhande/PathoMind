...
public class SecondFragmentcrtest extends Fragment {
     ...
     * @return A new instance of fragment SecondFragmentcrtest.
     */
    // TODO: Rename and change types and number of parameters
    public static SecondFragmentcrtest newInstance(String param1, String param2) {
        SecondFragmentcrtest fragment = new SecondFragmentcrtest();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_second_fragmentcrtest, container, false);
        button1 = (Button) view.findViewById(R.id.frag2button1);
        button2 = (Button) view.findViewById(R.id.frag2button2);
        button3 = (Button) view.findViewById(R.id.frag2button3);
        button4 = (Button) view.findViewById(R.id.frag2button4);
        button5 = (Button) view.findViewById(R.id.frag2button5);
        button6 = (Button) view.findViewById(R.id.frag2finalbutton);
        imageView1 = (ImageView) view.findViewById(R.id.frag2imgView1);
        imageView2 = (ImageView) view.findViewById(R.id.frag2imgView2);
        imageView3 = (ImageView) view.findViewById(R.id.frag2imgView3);
        imageView4 = (ImageView) view.findViewById(R.id.frag2imgView4);
        imageView5 = (ImageView) view.findViewById(R.id.frag2imgView5);
    ...
    ActivityResultLauncher<Intent> mGetContent = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            ...
            if (result.getResultCode() == Activity.RESULT_OK && mycode == 5){
                assert result.getData() != null;
                Bundle bundle = result.getData().getExtras();
                Bitmap bitmap = (Bitmap) bundle.get("data");
    ...
    private void uploadimages(String testuniquekey) {
        ...
        Bitmap bitmap5 = imageView5.getDrawingCache();
        ...
        uploadimage1(bitmap1,myref,bitmap2,bitmap3,bitmap4,bitmap5);
    }

    private void uploadimage1(Bitmap bitmap1, StorageReference myref, Bitmap bitmap2, Bitmap bitmap3, Bitmap bitmap4, Bitmap bitmap5) {
...
//        Uri filepath = Uri.parse(encod);
    ...
    private void uploadimage2(Bitmap bitmap2, StorageReference myref, Bitmap bitmap3, Bitmap bitmap4, Bitmap bitmap5) {
...
//        Uri filepath = Uri.parse(encod);
        myref.child("2").putBytes(by2)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        uploadimage3(bitmap3,myref, bitmap4, bitmap5);
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull @NotNull Exception e) {
    ...
    private void uploadimage3(Bitmap bitmap3, StorageReference myref, Bitmap bitmap4, Bitmap bitmap5) {
...
//        Uri filepath = Uri.parse(encod);
        myref.child("3").putBytes(by3)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        uploadimage4(bitmap4,myref,bitmap5);
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull @NotNull Exception e) {
    ...
    private void uploadimage4(Bitmap bitmap4, StorageReference myref, Bitmap bitmap5) {
...
//        Uri filepath = Uri.parse(encod);
    ...
    private void uploadimage5(StorageReference myref, Bitmap bitmap5) {
        ByteArrayOutputStream ba5 =new ByteArrayOutputStream(  );
        bitmap5.compress( Bitmap.CompressFormat.PNG,90,ba5 );

        byte[] by5=ba5.toByteArray();
//        String encod= Base64.encodeToString( by,Base64.DEFAULT );
//        Uri filepath = Uri.parse(encod);
        myref.child("5").putBytes(by5)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(getActivity(), "upload 5 success", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull @NotNull Exception e) {
                Toast.makeText(getActivity(), "upload 5 failed", Toast.LENGTH_SHORT).show();
